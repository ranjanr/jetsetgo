...
export default function MentorDashboard() {
  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-950 text-slate-100 min-h-screen">
      {/* Mentor Header */}
      <header className="border-b border-slate-800 bg-slate-900/60 p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <a href="/" className="text-xs text-violet-400 hover:text-violet-300 font-mono">
              ← Back to Workspace
            </a>
            <span className="text-slate-400">|</span>
            <span className="text-xs text-emerald-400 font-mono bg-emerald-950/60 border border-emerald-800/50 px-2 py-0.5 rounded font-semibold">
              Cohort Admin View
            </span>
          </div>
